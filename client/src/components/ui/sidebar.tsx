...
const sidebarMenuButtonVariants = cva(
  "ring-sidebar-ring relative gap-2 rounded-lg px-3 py-2 text-left text-sm transition-all duration-200 ease-out group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! group-data-[collapsible=icon]:rounded-md focus-visible:ring-2 peer/menu-button flex w-full items-center overflow-hidden outline-hidden group/menu-button disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0 text-sidebar-foreground/60 hover:text-primary hover:bg-primary/[0.06] active:scale-[0.98] data-active:bg-primary/[0.06] data-active:text-primary data-active:font-medium data-active:border data-active:border-primary/20 data-active:before:absolute data-active:before:left-0 data-active:before:top-1/2 data-active:before:-translate-y-1/2 data-active:before:h-3/5 data-active:before:w-1 data-active:before:rounded-r-full data-active:before:bg-primary group-data-[collapsible=icon]:data-active:before:hidden group-data-[collapsible=icon]:data-active:rounded-md group-data-[collapsible=icon]:data-active:border-primary/25 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground mb-1 last-child:mb-0",
  {
    variants: {
      variant: {
        default: "hover:bg-primary/[0.06] hover:text-primary",
        outline:
